...
class App(customtkinter.CTk):
    ...
    def sidebar(self):
        ...
        self.sidebar_frame = customtkinter.CTkFrame(
            self, corner_radius=0, width=250)
        ...
        self.pub = customtkinter.CTkLabel(
            self.sidebar_frame, text="", width=250, image=self.pub_image)
    ...
    def menu_bar(self):
        ...
        menu_file.add_cascade(label='Ouvrir un fichier csv',
                              command=self.get_path_file)
        ...
        menu_file.add_cascade(label='Actualiser',
                              command=self.controller.delete_cache)
        menu_file.add_separator()
    ...
    def header(self):
        ...
        self.logo_label = customtkinter.CTkLabel(self.logo_container, text="", height=145, image=self.logo, width=250)
        self.logo_label.grid(row=1, column=0)
        self.panel_logo_label = customtkinter.CTkLabel(
            self.logo_container, text="",  width=879, height=145, image=self.logo_welcome)
        self.panel_logo_label.grid(row=1, column=1, padx=0)
    ...
    def extrat_csv_son_panel(self):
        ...
        customtkinter.CTkLabel(self.dashboard_frame, text="Fichier csv:", 
            font=customtkinter.CTkFont(size=15, weight="bold")).grid(
            column=1, row=1, sticky='w', pady=15, padx=5)
    ...
    def transfert_son_panel(self):
        ...
        self.transfert_frame = customtkinter.CTkFrame(
            self, corner_radius=0, width=850)
        ...
        self.scrollable_sons_frame.grid(
            row=1, column=1, sticky=tk.W+tk.E, pady=15)
        ...
        self.scrollable_sons_list.grid(
            row=1, column=2, pady=15, sticky=tk.W+tk.E)
    ...
    def conversion_son_panel(self):
        ...
        self.conversion_frame = customtkinter.CTkFrame(
            self, corner_radius=0, width=850)
    ...
    def execute_download_thread(self, link):
        asyncio.run(self.controller.download_songs(link))

    def download_songs(self, link):
    ...
    def footer(self):
        ...
        self.footer_label = customtkinter.CTkLabel(
            self.footer_frame, text="Copyright © MNLV Africa Sarl Tous droits réservés",
            font=customtkinter.CTkFont(size=8, weight="bold")
        )
        self.footer_label.grid(
            row=0, column=1, columnspan=2, sticky='e', padx=300)
